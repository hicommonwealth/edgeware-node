...
pub fn development_genesis_config(
	...
	let extra_accounts: Vec<AccountId> = vec![
		get_from_seed::<AccountId>("Aaron"),
		get_from_seed::<AccountId>("Abigail"),
		get_from_seed::<AccountId>("Adam"),
		get_from_seed::<AccountId>("Alan"),
		get_from_seed::<AccountId>("Albert"),
		get_from_seed::<AccountId>("Alex"),
	];
	...
	GenesisConfig {
		...
		identity: Some(IdentityConfig {
			verifiers: vec![get_from_seed::<AccountId>("Alice")],
