...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn delete_ren_token(z: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((1_282_000 as Weight).saturating_mul(z as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(z as Weight)))
	}
	fn spend_tokens() -> Weight {
		(93_694_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(6 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn validate_and_mint() -> Weight {
		(301_449_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn burn() -> Weight {
		(135_466_000 as Weight)
